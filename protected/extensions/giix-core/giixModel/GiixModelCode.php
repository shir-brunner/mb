	...
	public function generateLabelsEx($table, $className) {
		...
		foreach ($table->columns as $column) {
			if ($column->isForeignKey) {
				...
				if(StringHelper::startsWith($label, trim(StringHelper::spaceBeforeCapitals($className))))
				{
					$label = trim(StringHelper::removeStart($label, trim(StringHelper::spaceBeforeCapitals($className))));
				}
...
<ul style="list-style-type: none; padding-left: 0;">
	<li><img src="http://giix.org/icons/love.png"> Show how you love giix on <a href="http://www.yiiframework.com/forum/_index.php?/topic/13154-giix-%E2%80%94-gii-extended/">the forum</a> and on its <a href="http://www.yiiframework.com/extension/giix">extension page</a></li>
	<li><img src="http://giix.org/icons/vote.png"> Upvote <a href="http://www.yiiframework.com/extension/giix">giix</a></li>
	<li><img src="http://giix.org/icons/powered.png"> Show everybody that you are using giix in <a href="http://www.yiiframework.com/forum/_index.php?/topic/19226-powered-by-giix/">Powered by giix</a></li>
